...
const FullData1 = [
  ...
  {
    category:"groceries",data:[
      { 
        pid: 5, 
        price: 25, 
        name: "Tata Salt | Vacuum Evaporated Iodised Salt | 1 kg", 
        image: "https://m.media-amazon.com/images/I/61aoHG0V6AL._SX679_.jpg", 
        rating: 4, 
        tag: ["salt", "groceries","tata salt"],
      
        specification: {
          parameter: [
            { name: "Flavour", value: "Iodised Salt" },
            { name: "Brand", value: "Tata" },
            { name: "Color", value: "White" },
            { name: "Specialty", value: "suitable for vegetarians" },
            { name: "Units", value: "1000.0 gram" },
          ],
    
          description: {
            paragraph: [
              "40 YEARS OF TRUST: Known as ‘Desk ka Namak’, Tata Salt offers a promise of Iodine guarantee",
      ...
      pid: 6, 
      price: 199, 
      name: "Trust Classic Sulphur Less Sugar, 1kg", 
      image: "https://m.media-amazon.com/images/I/61HzapjbWjL._SX569_.jpg", rating: 4, 
      tag: ["sugar", "groceries","sulphur less sugar"],
      specification: {
        parameter: [
          { name: "Form", value: "Crystal" },
          { name: "Brand", value: "Trust" },
          { name: "Flavour", value: "Sweet" },
          { name: "Color", value: "White" },
          { name: "Weight", value: "1000.0 gram" },
          { name: "Diet Type", value: "Vegetarian" },
        ],
  
        description: {
          paragraph: [
            "Made in Hygienic and Untouched Conditions",
            "Dissolve Instantly",
            "Double Refined White Crystal Sugar",
  ...
  [
    ...
    {category:"groceries",data:[
      { pid: 5, price: 25, name: "Tata Salt | Vacuum Evaporated Iodised Salt | 1 kg", image: "https://m.media-amazon.com/images/I/61aoHG0V6AL._SX679_.jpg", rating: 4, tag: ["salt", "groceries","tata salt"] },
      { pid: 6, price: 199, name: "Trust Classic Sulphur Less Sugar, 1kg", image: "https://m.media-amazon.com/images/I/61HzapjbWjL._SX569_.jpg", rating: 4, tag: ["sugar", "groceries","sulphur less sugar"] },
    ]},
    
  ]
  const tags1 = [{
    category: "electronic", tags: ["laptop", "desktop", "electronic", "computer", "lenovo", "lenovo laptop", "asus", "asus laptop", "hp 15s",
    "hp 14s", "vivobook 14", "lenovo ideapad", "hp"]
  },
 { category:"groceries" ,tags:["sugar","salt","tata salt","sulphur less sugar"]}
]

  export { data, trending, FullData, tagList ,data1,tags1,FullData1}