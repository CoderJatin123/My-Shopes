...
const Topbar = () => {
  ...
  return (
    <div className=' grid grid-cols-2  sm:grid-cols-8 justify-between items-center py-2 place-content-between md:bg-cyan-4001  sm:bg-yellow-4001 pt-8 sm:pt-3 sm:px-1 px-5 text-primary'>
      ...
      <div className='w-full rounded-sm my-6 sm:my-2 sm:col-span-2 flex flex-row justify-end sm:order-2 col-span-2 order-3'>
        {/* searchbar */}
        <input id="search" type={'text'} className=' bg-gray-200 h-full sm:px-2  py-3 sm:py-2 px-3 hover:outline-none outline-none rounded-md sm:rounded-sm text-sm   w-full' placeholder='Search here'  />
      </div>
      ...
      <div className='place-self-center justify-start sm:justify-end flex flex-row sm:text-sm text-base  font-semibold  sm:col-span-3 col-span-2 sm:order-3 order-4 w-full '>
        {/* all options */}
        <div className='flex flex-row sm:w-11/12  md:ml-10 w-9/12 lg:w-1/2 justify-between '>
           <h3>Category</h3>
           <h3>Trending</h3>
                <div  className='flex flex-row'>
                 <h5 className='text-sm  font-semibold'>(5)</h5>
        ...
        <button className=' border-primary opacity-70 border-2 py-1 rounded-md sm:rounded-sm px-2'>Login</button>
